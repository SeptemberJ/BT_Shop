  ...
  saveReceipt: function(){
    ...
    if (this.data.receiptTel.indexOf('-') > 0) {
      ...
      if (this.data.receiptName == '') {
        ...
        wx.request({
          url: h.main + '/insertreceipt',
          data: {
            oppenid: app.globalData.oppenid,
            receiptKindNS: this.data.receiptKindNS,
            setDefault: this.data.setDefault,
            receiptName: this.data.receiptName,
            receiptNumber: this.data.receiptNumber,
            receiptAddress: this.data.receiptAddress,
            receiptTel: this.data.receiptTel,
            receiptBank: this.data.receiptBank,
            receiptBankCode: this.data.receiptBankCode,
            receiptEmail: this.data.receiptEmail,
          },
      ...
      console.log(this.data.receiptKindNS)
      console.log(this.data.setDefault)
      console.log(this.data.receiptName)
      console.log(this.data.receiptNumber)
      console.log(this.data.receiptAddress)
      console.log(this.data.receiptTel)
      console.log(this.data.receiptBank)
      console.log(this.data.receiptBankCode)
      console.log(this.data.receiptEmail)
